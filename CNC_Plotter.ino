...
Stepper myStepperY(stepsPerRevolution,12,13,3,4);         
...
void drawLine(float x1, float y1) {
  ...
  //if(changeX >= 0) digitalWrite(dirPinX, HIGH);
  //else digitalWrite(dirPinX, LOW);

  //if(changeY >= 0) digitalWrite(dirPinY, HIGH);
...
// when in1 is HIGH, pen moves down, when its LOW, pen moves up
//  Raises pen
void penUp() { 
